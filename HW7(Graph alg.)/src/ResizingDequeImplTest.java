...
public class ResizingDequeImplTest {
    ...
    public void iteratorTest() {
        ...
        Iterator<Integer> dequeIterator = newDeque.iterator();
        
        assertEquals(1, (int) dequeIterator.next());
        assertEquals(2, (int) dequeIterator.next()); 
        assertEquals(3, (int) dequeIterator.next());
